...
urlpatterns = [
    ...
    path(
        ...
        name="Brightnes_filter_url"),
    path(
        'filtering/Grayscale',
        views.GrayscaleFilterView.as_view(),
        name="Grayscale_filter_url"),
    path(
        'filtering/Negative',
        views.NegativeFilterView.as_view(),
        name="Negative_filter_url"),
    path(
        'filtering/Noises',
        views.NoisesFilterView.as_view(),
        name="Noises_filter_url"),
    path(
        'filtering/Sepia',
        views.SepiaFilterView.as_view(),
        name="Sepia_filter_url"),
    path(
        'filtering/Blur',
        views.BlurFilterView.as_view(),
        name="Blur_filter_url")
]
